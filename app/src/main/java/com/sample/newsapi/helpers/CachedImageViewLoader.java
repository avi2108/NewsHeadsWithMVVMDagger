...
import com.sample.newsapi.BuildConfig;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (bitmap != null)
                    ...
                    final BitmapWorkerTask task = new BitmapWorkerTask(imageView);//checks diskcache else downloads bitmap
...
//                imageView.setImageBitmap(bitmap);
    ...
    /**
     * download bitmap from url (own implementation and also Glide api)
     *
     * @param data url
     * @return
     */
...
//                    with(context).
//                    asBitmap().
//                    load(data).into(new CustomTarget<Bitmap>(){
//                @Override
...
//        }
        //commented my above implementation of download and bitmap conversion task and took help of Glide api just to take use of its faster
        // inside threadpool approach
        try {
            return Glide.
                    with(context).
                    asBitmap().
                    load(data).into(imageWidth, imageHeight).get();
